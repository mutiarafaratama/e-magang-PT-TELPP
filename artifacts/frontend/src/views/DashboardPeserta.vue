      ...
      <template v-if="activeTab === 'beranda'">
        ...
        <div class="stats-row">
          <div class="stat-card">
            ...
            <div><div class="stat-card__label">Status Pengajuan</div><div class="stat-card__value">Belum Diajukan</div></div>
          </div>
          <div class="stat-card">
      ...
      <template v-else-if="activeTab === 'pengajuan'">
        <div class="card">
          ...
          <div class="empty-state">
            <div class="empty-state__icon"><svg width="40" height="40" viewBox="0 0 24 24" fill="none"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" stroke="#d1d5db" stroke-width="1.5"/><polyline points="14 2 14 8 20 8" stroke="#d1d5db" stroke-width="1.5"/></svg></div>
            <p>Belum ada pengajuan magang.<br/>Klik tombol di bawah untuk mulai.</p>
            <button class="btn-green">+ Buat Pengajuan Baru</button>
          </div>
        </div>
      </template>
...
.step {
  ...
  padding: 14px 0; border-bottom: 1px solid #f8faf8;
}
